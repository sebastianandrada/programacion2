...
namespace CentralitaHerencia
{
    public class Centralita: IGuardar<Centralita>
    {
        ...
        public bool Guardar(Centralita obj)
        {
            float gananciasLocal = obj.GananciasPorLocal;
            float gananciasProvincial = obj.GananciasPorProvincial;
            float gananciasTotal = obj.GananciasPorTotal;
            List<Llamada> llamadas = obj.Llamadas;
